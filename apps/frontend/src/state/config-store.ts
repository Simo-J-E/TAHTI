...
const getThemes = (): Theme[] => [
  ...
  },
  {
    ...
    colors: {
      ...
      accent: "rgb(183, 78, 60)",
      accentSecondary: "rgb(154, 58, 43)",
      success: "rgb(34, 197, 94)",
      warning: "rgb(245, 158, 11)",
      error: "rgb(239, 68, 68)",
      headerAccent: "rgb(183, 78, 60)",
      headerAccentSecondary: "rgb(154, 58, 43)",
...
const useConfigStore = create<ConfigState>()(
  persist(
    (set, get) => ({
      ...
      toggleLightDarkMode: () => {
        const currentlyLight = get().isCurrentThemeLight();
        set((state) => ({
          config: {
            ...state.config,
            appearance: currentlyLight ? "dark" : "light",
          },
        }));
      },
    }),
