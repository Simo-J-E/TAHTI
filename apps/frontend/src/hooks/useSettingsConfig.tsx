        ...
        components: [
          {
            ...
            data: {
              label: t("sections.styling.appearance.label"),
              subtitle: t("sections.styling.appearance.subtitle"),
              value: config.appearance,
              options: [
                { value: "system", label: t("sections.styling.appearance.options.system") },
                { value: "light", label: t("sections.styling.appearance.options.light") },
                { value: "dark", label: t("sections.styling.appearance.options.dark") },
              ],
              onChange: (value) =>
