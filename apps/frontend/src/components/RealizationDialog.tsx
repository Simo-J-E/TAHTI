              ...
              >
                <div className="p-4">
                  ...
                  >
                    ...
                    {isFinnish
                      ? "Tämä lista saattaa olla puutteellinen. TAHTI yhdistää kalenteritapahtumia tähän toteutukseen nimessä sijaitsevan toteutuskoodin perusteella (esim. kh00cz65-302). Jos tämä koodi puuttuu tapahtuman nimestä, se ei näy tässä listassa. Viraallisen listan löydät viraallisesta lukkarikoneesta."
                      : "This may not be an exhaustive list! TAHTI associates events to this realization by the realization code in their name (e.g. kh00cz65-302). If this code is missing, the specific event won't show up in this list. You can view an exhaustive list in the official Lukkarikone."}
                  </div>
